  ...
  return (
    <>
      ...
      <Section className="bg-eza-gray !min-h-0">
        <FadeIn delay={200}>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-eza-text mb-4 md:mb-8">Portal Özellikleri</h2>
          <div className="grid md:grid-cols-2 gap-3 md:gap-6">
            <div className="bg-white rounded-lg p-4 md:p-6 border border-gray-200">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                ...
                <h3 className="text-base md:text-xl font-semibold text-eza-text">Çok Tenantlı Yapı</h3>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 md:p-6 border border-gray-200">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-eza-blue/10 flex items-center justify-center">
                  <Icon name="Navigation" className="text-eza-blue" size={20} />
                </div>
                <h3 className="text-base md:text-xl font-semibold text-eza-text">Merkezi Yönlendirme</h3>
              </div>
                <p className="text-xs md:text-base text-eza-text-secondary">
            ...
            <div className="bg-white rounded-lg p-4 md:p-6 border border-gray-200">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-eza-blue/10 flex items-center justify-center">
                  <Icon name="Shield" className="text-eza-blue" size={20} />
                </div>
                <h3 className="text-base md:text-xl font-semibold text-eza-text">Güvenlik ve İzolasyon</h3>
              </div>
                <p className="text-xs md:text-base text-eza-text-secondary">
            ...
            <div className="bg-white rounded-lg p-4 md:p-6 border border-gray-200">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-eza-blue/10 flex items-center justify-center">
                  <Icon name="BarChart3" className="text-eza-blue" size={20} />
                </div>
                <h3 className="text-base md:text-xl font-semibold text-eza-text">Merkezi Raporlama</h3>
              </div>
                <p className="text-xs md:text-base text-eza-text-secondary">
      ...
      <Section className="bg-white !min-h-0">
        <FadeIn delay={300}>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-eza-text mb-4 md:mb-6">Kurum Kategorileri</h2>
          <div className="space-y-3 md:space-y-6">
            <div className="border-l-4 border-eza-blue pl-3 md:pl-6">
              <h3 className="text-base md:text-xl font-semibold text-eza-text mb-1 md:mb-2">Corporate</h3>
                <p className="text-xs md:text-base text-eza-text-secondary">
            ...
            <div className="border-l-4 border-eza-green pl-3 md:pl-6">
              <h3 className="text-base md:text-xl font-semibold text-eza-text mb-1 md:mb-2">Regulator</h3>
                <p className="text-xs md:text-base text-eza-text-secondary">
            ...
            <div className="border-l-4 border-eza-gold pl-3 md:pl-6">
              <h3 className="text-base md:text-xl font-semibold text-eza-text mb-1 md:mb-2">Developer</h3>
                <p className="text-xs md:text-base text-eza-text-secondary">
                Geliştirici konsolları. API yönetimi ve entegrasyon araçları.
              </p>
            </div>
            <div className="border-l-4 border-eza-text pl-3 md:pl-6">
              <h3 className="text-base md:text-xl font-semibold text-eza-text mb-1 md:mb-2">Özel Kategoriler</h3>
                <p className="text-xs md:text-base text-eza-text-secondary">
